...
| **3.4** | [**xUDT (Extensible UDT)**](./3.4_xudt/README.md) | Minting and managing programmable fungible tokens on CKB | 🟢 **Validated On-Chain** ([Tx Proof](https://pudge.explorer.nervos.org/transaction/0x7460cde8a0952c25b13c0727b0cad87cfb1795286ea35af2eca3b1ea4de8f612)) |
| **3.5** | [**Simple Lock**](./3.5_simple-lock/README.md) | Custom Lock Script contract and frontend wallet integration | 🟢 **Validated On-Chain** ([Tx Proof](https://pudge.explorer.nervos.org/transaction/0x85d55b173b7f38754a48342fcb79b0740d9d8d7407b014628edcee174b82e8dd)) |
